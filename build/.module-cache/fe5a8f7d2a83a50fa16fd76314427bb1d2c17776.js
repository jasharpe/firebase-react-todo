...
var Todo = React.createClass({displayName: "Todo",
  ...
  render: function() {
    ...
    var deleteButton = (
      React.createElement("button", {onClick: this.onClickDelete, type: "button", className: "close", "aria-label": "Close"}, 
        React.createElement("span", {
          "aria-hidden": "true", 
          dangerouslySetInnerHTML: {__html: '&times;'}})
      ));
    // TODO: deleteButton should show unless last AND empty.
    // Currently shows if not empty.
    return (
      React.createElement("li", {
        ...
        this.state.hasText ? deleteButton : null
      )
    );
  }
});
