    ...
    return (
      React.createElement("div", null, 
        React.createElement("div", {id: "list_page"}, 
          React.createElement("a", {onClick: this.props.app.navOnClick({page: "LISTS"}), href: "/#/lists", id: "lists_link", className: "btn btn-primary"}, "Back to Lists")
        ), 
    ...
    if (this.state.page === "LIST") {
      return (
        React.createElement(ListPage, null, 
          React.createElement(TodoList, {app: this, todoListKey: this.state.todoListKey})
        )
      );
