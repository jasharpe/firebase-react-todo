var Check = React.createClass({displayName: "Check",
  ...
  componentWillMount: function() {
    this.ref = new Firebase("https://glaring-fire-5349.firebaseio.com/react_todos/" + this.props.todoKey + "/checked");
  ...
  render: function() {
    ...
    return (
      React.createElement("a", {onClick: this.toggleCheck, href: "#", className: "pull-left todo-check" + doneClass}, 
  ...
  render: function() {
    return (
      React.createElement("li", {id: this.props.todoKey, className: "list-group-item todo"}, 
        React.createElement(Check, {todoKey: this.props.todoKey}), 
        React.createElement("span", {
